...
interface JwtPayload {
  ...
  return (
    ...
    <figure className = "m-3 mt-5 inline-block">
      ...
      <Image src="/your_song.jpg" alt="Homepage" width={120} height={120} className="rounded-lg inline-block" />
      <figcaption className='inline-block relative left-5 hover:underline'>Parokya ni Edgar- Your song</figcaption></Link>
    </figure>
        <figure className = "m-3 mt-5 inline-block">
   ...
   <main className="ml-[50px]">
      ...
      <iframe width="905" height="500" src="https://www.youtube.com/embed/5qq8ONq0hl8?si=oRVXNV7iVwtRIOGt" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
