...
export default function DashboardPage() {
    ...
    async function fetchPositions() {
        ...
        try {
            ...
            if (res.status === 401) {
                // aunauthorizd - log out and redirect
                logoutUser();
                router.push('/login');
                return;
            }
                    ...
                    <CardContent>
                        ...
                        <form onSubmit={handleCreateOrUpdate} className="grid grid-cols-1 md:grid-cols-3 gap-3">
                            <Input
                                ...
                                value={positionCode}
                                onChange={(e) => setPositionCode((e.target as HTMLInputElement).value)}
                                required
                            />
                            <Input
                                placeholder="Position Name"
                                value={positionName}
                                onChange={(e) => setPositionName((e.target as HTMLInputElement).value)}
                                required
                            />
